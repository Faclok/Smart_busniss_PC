...
{
    public class VerticalProduct : MonoBehaviour
    {
        ...
        /// </summary>
        [Header("Prefab")]
        [SerializeField] private ProductBehaviour _prefabProduct;
        ...
        /// Установление машины
        /// </summary>
        private ProductBehaviour[] _productBehaviours = new ProductBehaviour[0];
